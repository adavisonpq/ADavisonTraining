...
public class ExampleProperties {
	...
	protected static Log log = LogFactory.getLog(ExampleProperties.class);
	...
	protected void loadProperties(String filename) throws IOException {
		log.info("Load Example properties ..");
		...
		try {
			...
			log.info("ExampleProperties#loadProperties  example.properties is loaded..");
		} finally {
			if (inputStream != null)
				inputStream.close();
		}
